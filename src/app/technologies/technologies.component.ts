...
@Component({
  ...
  styleUrls: ['./technologies.component.scss', './technologies.component2.scss', './technologies.component.responsive.scss', './technologies.component.responsive2.scss', './technologies.component.responsive3.scss']
})
